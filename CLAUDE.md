...
This file is the source of truth for Claude / Codex-style agents working in
...
| `AGENTS.md` / `CLAUDE.md` (optional) | Module-scoped agent rules. Only present when the rules differ from the top-level CLAUDE.md. | Rare. |
...
(see CLAUDE.md § "Spec-Before-Code Planning Discipline" / "Execution
...
the authoritative source per CLAUDE.md § "Definitions — reference vs.
